...
const Crear = () => {
  ...
  const { crearCliente, errores } = useContext(ClientContext);
    ...
    <div className="w-screen h-screen bg-gray-700 overflow-x-hidden">
      ...
      <main className="max-w-[75%] mx-auto">
        <form className="w-[50%] mx-auto mt-10" onSubmit={onSubmit}>
          ...
          />
          {errores && (
            <div className="py-4 text-white bg-redDefault rounded-md flex items-center justify-center">
              {errores}
            </div>
          )}
          <Input
          ...
          <button
            type="submit"
            className="py-2 px-5 bg-slate-900 rounded-md text-white float-right"
          >
            {" "}
            Crear
          </button>
